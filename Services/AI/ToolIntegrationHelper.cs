...
public class ToolIntegrationHelper
{
    ...
    /// </summary>
    public static OAI.Core.Interfaces.Tools.ToolExecutionContext ConvertToToolExecutionContext(OptimalyAI.Services.AI.Models.ToolExecutionContext ollamaContext)
    {
...
Remember to always use the exact tool IDs as specified above when making function calls.";
    ...
    /// </summary>
    public static string FormatToolResultForConversation(ToolResult result)
    {
        if (result.IsSuccess)
        {
    ...
    /// </summary>
    public static OllamaChatMessage CreateToolResultMessage(List<ToolResult> results)
    {
        var content = string.Join("\n\n", results.Select(FormatToolResultForConversation));
