...
namespace OAI.DataLayer.Migrations
{
    ...
    [Migration("20250625095217_AddConversationModelToOrchestratorConfiguration")]
    partial class AddConversationModelToOrchestratorConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OAI.Core.Entities.Adapters.AdapterDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_AdapterDefinition_CreatedAt");

                    b.ToTable("AdapterDefinitions");
                });

            modelBuilder.Entity("OAI.Core.Entities.Adapters.AdapterExecution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("AdapterDefinitionId")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("InputDataPreview")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("OutputDataPreview")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("AdapterDefinitionId");
            ...
            modelBuilder.Entity("OAI.Core.Entities.AiServer", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_AiServer_CreatedAt");
            ...
            modelBuilder.Entity("OAI.Core.Entities.Business.Request", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_Request_CreatedAt");
            ...
            modelBuilder.Entity("OAI.Core.Entities.Business.RequestNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_RequestNote_CreatedAt");
            ...
            modelBuilder.Entity("OAI.Core.Entities.OrchestratorConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("OrchestratorId")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_OrchestratorConfiguration_CreatedAt");

                    b.HasIndex("DefaultModelId");

                    b.ToTable("OrchestratorConfigurations");
                });

            modelBuilder.Entity("OAI.Core.Entities.OrchestratorSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("IsDefaultChatOrchestrator")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsWorkflowNode")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_OrchestratorSettings_CreatedAt");

                    b.ToTable("OrchestratorSettings");
                });

            modelBuilder.Entity("OAI.Core.Entities.Programming.WebApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_WebApplication_CreatedAt");
            ...
            modelBuilder.Entity("OAI.Core.Entities.Projects.ProjectConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("AutoSelectModel")
                        .HasColumnType("boolean");

                    b.Property<bool>("AutoSelectTools")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_ProjectConversation_CreatedAt");
            ...
            modelBuilder.Entity("OAI.Core.Entities.Adapters.AdapterExecution", b =>
                {
                    b.HasOne("OAI.Core.Entities.Adapters.AdapterDefinition", "AdapterDefinition")
                        .WithMany()
                        .HasForeignKey("AdapterDefinitionId")
            ...
            modelBuilder.Entity("OAI.Core.Entities.Business.RequestExecution", b =>
                {
                    ...
                    b.HasOne("OAI.Core.Entities.Business.Request", "Request")
                        .WithMany("Executions")
            ...
            modelBuilder.Entity("OAI.Core.Entities.OrchestratorConfiguration", b =>
                {
                    ...
                    b.HasOne("OAI.Core.Entities.AiModel", "ConversationModel")
                        .WithMany()
                        .HasForeignKey("ConversationModelId");

                    b.HasOne("OAI.Core.Entities.AiModel", "DefaultModel")
                        .WithMany()
                        .HasForeignKey("DefaultModelId");

                    b.Navigation("AiServer");

                    b.Navigation("ConversationModel");
